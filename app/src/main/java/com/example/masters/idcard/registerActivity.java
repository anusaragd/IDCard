...
//        });
        ...
        mGetCardInfo = (Button) findViewById(R.id.read_reg);
        ...
        //###### Initial TextView ######//
        txtIDCard = (TextView) findViewById(R.id.idcard_reg);
        txtTitleTH = (TextView) findViewById(R.id.user_reg);
//        txtFirstNameTH = (TextView) findViewById(R.id.textViewFirstNameTH);
//        txtLastNameTH = (TextView) findViewById(R.id.textViewLastNameTH);
        txtTitleEN = (TextView) findViewById(R.id.password_reg);
...
//      //# Photo
        ...
        ImageView imgPhoto = (ImageView)findViewById(R.id.imageView3);
